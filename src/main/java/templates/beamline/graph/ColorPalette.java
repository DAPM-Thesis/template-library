...
public class ColorPalette {
    ...
    public static ColorPalette.Colors create(String color) {
        switch (color.toLowerCase()) {
            case "violet":  return ColorPalette.Colors.VIOLET;
            case "green": return ColorPalette.Colors.GREEN;
            case "orange": return ColorPalette.Colors.ORANGE;
            case "yellow": return ColorPalette.Colors.YELLOW;
            case "red": return ColorPalette.Colors.RED;
            case "pink": return ColorPalette.Colors.PINK;
            case "aqua": return ColorPalette.Colors.AQUA;
            case "gray": return ColorPalette.Colors.GRAY;
            case "dark_gray": return ColorPalette.Colors.DARK_GRAY;
            default: return ColorPalette.Colors.BLUE;
        }
    }
}
